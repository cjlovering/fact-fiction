...
{
    public sealed class BingV5Finder : BingFinder
    {
        protected override string BingUrl { get; } = "https://api.cognitive.microsoft.com/bing/v5.0/search";
        protected override string CognitiveServicesSubscriptionKey { get; } = "918ef5f1ab6040bbaf1d7d7965f5b5ad";
